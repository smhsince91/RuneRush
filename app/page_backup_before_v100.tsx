...
export default function RuneRushPixiFullPage() {
  ...
  const boardKey = useMemo(() => `pixi-full-v97-${levelIndex}-${resetKey}`, [levelIndex, resetKey]);
    ...
    <main className="pageShell">
            ...
            <div>
              ...
              <div className="goalTitle">
                ...
                {hud.objectiveKind === "ingredient" && hud.ingredient && (
                  <span className="goalInlineIngredient" aria-label="ingredients dropped">
                    <span className="ingredientMini">◆</span>
      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        .goalIcon.ingredient { color: #ffe29a; }
        ...
        .goalInlineIngredient { display: inline-flex; align-items: center; gap: 5px; margin-left: 7px; }
        .ingredientMini { display: inline-grid; place-items: center; width: 21px; height: 21px; border-radius: 999px; color: #ffe5a7; background: rgba(255, 211, 121, 0.10); box-shadow: none; font-size: 15px; }
        .chipRune {
          width: 28px;
          height: 28px;
          display: inline-grid;
